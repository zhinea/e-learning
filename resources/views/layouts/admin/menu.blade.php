        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
               {{--  <li class=" nav-item"><a class="d-flex align-items-center" href="index.html"><i data-feather="home"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Dashboards</span><span class="badge badge-light-warning badge-pill ml-auto mr-1">2</span></a>
                ...
                <li class=" navigation-header"><span data-i18n="Apps Management">Apps Management</span><i data-feather="more-horizontal"></i>
                </li>


                <x-vertical-single-menu
                    :href="route('staff.management.users.index')"
                    :active="request()->is('staff/management/users*')"
                    icon="users">
                    Users
                </x-vertical-single-menu>
                ...
                <x-vertical-single-menu
                    href="/"
                    :active="request()->is('staff/management/permissions*')"
                    icon="lock">
                    Permissions
                </x-vertical-single-menu>
                ...
                <x-vertical-single-menu
                    href="/"
                    :active="request()->is('staff/management/roles*')"
                    icon="shield">
                    Roles
                </x-vertical-single-menu>

                <li class=" navigation-header"><span data-i18n="Apps &amp; Features">Apps &amp; Features</span><i data-feather="more-horizontal"></i>
                </li>
